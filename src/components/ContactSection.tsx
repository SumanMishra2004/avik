...
export default function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // In a real app, send to API. For now, construct mailto link.
  ...
  const CONTACT_CARDS = [
    ...
    },
    {
      ...
      color: "from-indigo-600 to-[#C8A558]",
    },
    {
      icon: <ExternalLink size={20} />,
      label: "ORCID",
      value: "0000-0001-8824-703X",
      href: personalInfo.orcid,
      color: "from-sky-600 to-[#C8A558]",
    },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-[#94A3B8] text-lg max-w-2xl mx-auto">
            Have a research idea, project collaboration, or academic partnership
            in mind? I&apos;d love to hear from you. Let&apos;s build something
            impactful together.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          >
            ...
            {CONTACT_CARDS.map((card, i) => (
              ...
              >
                <div
                  className={`w-10 h-10 rounded-xl bg-gradient-to-br ${card.color} flex items-center justify-center text-white flex-shrink-0 group-hover:shadow-[0_0_15px_rgba(200,165,88,0.3)] transition-shadow`}
                >
                  {card.icon}
                </div>
                <div className="min-w-0">
                  <div className="text-[#64748B] text-xs mb-0.5">{card.label}</div>
                  <div className="text-[#F1F5F9] text-sm font-medium truncate group-hover:text-[#C8A558] transition-colors">
                    {card.value}
                  </div>
                </div>
              </motion.a>
            ...
            >
              <p className="text-[#64748B] text-xs mb-4 uppercase tracking-widest hf-mono">
                Social Profiles
              </p>
              <div className="space-y-3">
                {SOCIAL_LINKS.map((social, i) => (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <div className="text-[#94A3B8] text-xs group-hover:text-[#C8A558] transition-colors truncate">
                        {social.value}
                      </div>
                    </div>
                  </a>
          ...
          >
            ...
            >
              <h3 className="hf-display font-bold text-xl text-white mb-6">
                Send a Message
              </h3>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-[#94A3B8] text-xs mb-2 font-medium uppercase tracking-wider">
                        Your Name *
                      </label>
                      <input
                        id="contact-name"
                        ...
                        className="w-full px-4 py-3 rounded-xl glass-card border border-white/10 text-white placeholder:text-[#64748B] text-sm focus:outline-none focus:border-[#C8A558]/50 focus:bg-white/5 transition-all"
                      />
                    </div>
                    <div>
                      <label className="block text-[#94A3B8] text-xs mb-2 font-medium uppercase tracking-wider">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Research Collaboration — 6G Channel Modeling"
                      className="w-full px-4 py-3 rounded-xl glass-card border border-white/10 text-white placeholder:text-[#64748B] text-sm focus:outline-none focus:border-[#C8A558]/50 focus:bg-white/5 transition-all"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl glass-card border border-white/10 text-white placeholder:text-[#64748B] text-sm focus:outline-none focus:border-[#C8A558]/50 focus:bg-white/5 transition-all resize-none"
                    />
                  </div>
                  ...
                  <motion.button
                    ...
                    whileHover={{
                      scale: 1.02,
                      boxShadow: "0 0 30px rgba(200,165,88,0.4)",
                    }}
                    whileTap={{ scale: 0.98 }}
